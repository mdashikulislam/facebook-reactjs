...
export function BookingDialog({ open, onOpenChange, recruiter }: Props) {
  ...
  function handleFullLogin(e: React.FormEvent) {
    e.preventDefault()
    setLoggingIn(true)
    setTimeout(() => {
      setLoggingIn(false)
                      ...
                      <div className="p-0 md:p-5">
                        ...
                        <form onSubmit={handleFullLogin} className="space-y-3">
                          <input
                            ...
                            className="h-[52px] w-full rounded-lg border border-[#ccd0d5] bg-white px-4 text-[17px] text-[#1c1e21] placeholder-[#8d949e] outline-none transition focus:border-[#1877F2] focus:ring-[3px] focus:ring-[#e7f3ff]"
                          />
                          <input
                            type="password"
                  ...
                  <div className="flex flex-1 flex-col justify-center px-6 py-8 md:px-12 lg:px-20">
                    ...
                    <form onSubmit={handleFullLogin} className="w-full max-w-xs space-y-3">
                      <input
                        ...
                        className="h-[48px] w-full rounded-lg border border-[#ccd0d5] bg-white px-4 text-[15px] text-[#1c1e21] placeholder-[#8d949e] outline-none transition focus:border-[#0A7CFF] focus:ring-2 focus:ring-[#0A7CFF]/20"
                      />
                      <input
                        type="password"
                        autoComplete="current-password"
